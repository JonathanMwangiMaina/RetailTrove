...
export default function Home() {
  useEffect(() => {
    document.title = "RetailTrove - Your Online Shopping Destination";
  }, []);
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Organization",
            name: "RetailTrove",
            url: "https://retailtrove.com",
            logo: "https://retailtrove.com/logo.png",
            description: "Your Online Shopping Destination — premium products for your lifestyle.",
            sameAs: [
              "https://facebook.com/retailtrove",
              "https://twitter.com/retailtrove",
              "https://instagram.com/retailtrove",
            ],
          }),
        }}
      />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-white">
            <div className="max-w-xl">
              ...
              <p className="mt-4 text-xl">
                Discover our latest collection of premium products for your lifestyle.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-base text-gray-500">
              Check out our latest products just added to our inventory.
            </p>
          </div>
              ...
              <div className="absolute inset-0 flex items-center justify-center z-20">
                <div className="text-center">
                  ...
                  <Link href="/shop/Clothing">
                    <Button
                      size="sm"
                      className="mt-4 bg-white text-primary-900 hover:bg-gray-100 rounded-full"
                    >
                      Shop Now
                    </Button>
                  </Link>
              ...
              <div className="absolute inset-0 flex items-center justify-center z-20">
                <div className="text-center">
                  ...
                  <Link href="/shop/Clothing">
                    <Button
                      size="sm"
                      className="mt-4 bg-white text-secondary-900 hover:bg-gray-100 rounded-full"
                    >
                      Shop Now
                    </Button>
                  </Link>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-base text-gray-500">
              Don't just take our word for it — see what customers are saying about our products.
            </p>
          </div>
