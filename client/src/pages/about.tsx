      ...
      <div className="relative bg-gray-50">
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 text-xl text-white max-w-3xl">
            We're dedicated to bringing you premium quality products with exceptional design and
            craftsmanship.
          </p>
        </div>
      </div>
            ...
            {dbContent ? (
              <div className="space-y-4 mt-4">
                {dbContent
                  ...
                  .map((p: string, i: number) => (
                    <p key={i} className="text-lg text-gray-500 whitespace-pre-line">
                      {p.trim()}
                    </p>
                  ))}
              </div>
              ...
              <>
                <p className="mt-4 text-lg text-gray-500">
                  ModernRetail began with a simple idea: to create a shopping experience that
                  prioritizes quality, design, and customer satisfaction. Founded in 2018, we've
                  grown from a small start-up to a trusted destination for design-conscious
                  shoppers.
                </p>
                <p className="mt-4 text-lg text-gray-500">
                  Our team of passionate designers and curators search the globe for exceptional
                  products that combine functionality with beautiful aesthetics. We believe that
                  everyday items should bring joy and inspire thoughtful living.
                </p>
                <p className="mt-4 text-lg text-gray-500">
                  From premium watches to minimalist home goods, every item in our collection is
                  carefully selected to ensure it meets our high standards for quality and design
                  excellence.
                </p>
              </>
            )}
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-3">
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="mt-2 text-base text-gray-500">
                We never compromise on quality. Every product we offer is carefully vetted to ensure
                it meets our high standards for materials, craftsmanship, and durability.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="mt-2 text-base text-gray-500">
                We believe that good design solves problems. Our products combine aesthetics with
                functionality to enhance your everyday life in meaningful ways.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="mt-2 text-base text-gray-500">
                We partner with manufacturers who share our commitment to ethical production
                practices, fair labor standards, and sustainable materials.
              </p>
            </div>
          </div>
        </div>
