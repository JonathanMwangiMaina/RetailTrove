-- v0.10.0: Update site_content with the rewritten, industry-best-practice
-- Privacy Policy and Terms of Service. Single idempotent statement (Supabase CLI
-- executes one statement per file). Run: supabase db query --linked --file /mnt/wsl/RetailTrove/migrations/0011_legal_policies.sql

INSERT INTO public.site_content (type, content, updated_at)
VALUES
...
## 16. Contact Us
If you have any questions about this Privacy Policy or our privacy practices, please contact us at privacy@retailtrove.com or +1 (555) 123-4567, or write to 123 Commerce Street, New York, NY 10001, United States.$$, now()),
...
## 17. Contact Us
If you have any questions about these Terms and Conditions, please contact us at legal@retailtrove.com or +1 (555) 123-4567, or write to 123 Commerce Street, New York, NY 10001, United States.$$, now())
