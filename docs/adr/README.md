...
| 002 | [Repository Pattern with IStorage](ADR-002-repository-pattern.md) | ✅ Accepted |
| 003 | [Dual-Mode Deployment (Dev + Serverless)](ADR-003-dual-mode-deployment.md) | ✅ Accepted |
...
| 006 | [Payment Idempotency Strategy](ADR-006-payment-idempotency.md) | ✅ Accepted |
